...
<script>
	...
	function checkUsername(){
		...
		// 3.打开连接
		xhr.open("GET","${basepath}/user_findByName.action?time="+new Date().getTime()+"&username="+username,true);
		// 4.发送
		xhr.send(null);
	}
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${basepath}/user_regist.action"  method="post" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
							<tbody><tr>
								<th>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<%--<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img id="checkImg" class="captchaImage" src="${basepath}/checkImg.action" onclick="change()" title="点击更换验证码">
										</span>
									--%></td>
								</tr>
							<tr>
