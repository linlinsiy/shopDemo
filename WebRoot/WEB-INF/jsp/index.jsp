	...
	<div class="span5">
		<div class="logo">
			<a href="./网上商城/index.htm">
				<img src="${basepath}/image/r___________renleipic_01/logo.gif" alt="传智播客"/>
			</a>
		</div>
	</div>
	<div class="span9">
...
<!-- 					<div class="hotProductAd">
			<img src="${basepath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<ul class="tabContent" style="display: block;">
									<li>
										<a target="_blank"><img src="${basepath}/image/b.jpg" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
									</li>
									<li>
										<a  target="_blank"><img src="${basepath}/image/c.jpg" data-original="http://storage.shopxx.net/demo-image/3.0/201301/51afeef5-f6cb-4936-abea-315cfca0edc0-thumbnail.jpg" style="display: block;"></a>
									</li>
									<li>
										<a  target="_blank"><img src="${basepath}/image/d.jpg" style="display: block;"></a>
									</li>
									<li>
										<a  target="_blank"><img src="${basepath}/image/e.jpg" style="display: block;"></a>
									</li>
									<li>
										<a target="_blank"><img src="${basepath}/image/f.jpg" style="display: block;"></a>
									</li>
									<li>
										<a  target="_blank"><img src="${basepath}/image/g.jpg" style="display: block;"></a>
									</li>
									<li>
										<a  target="_blank"><img src="${basepath}/image/h.jpg" style="display: block;"></a>
									</li>
									<li>
										<a target="_blank"><img src="${basepath}/image/i.jpg" style="display: block;"></a>
									</li>
									<li>
										<a target="_blank"><img src="${basepath}/image/i.jpg" style="display: block;"></a>
									</li>
...
<!-- 					<div class="newProductAd">
						 ...
						 <ul class="tabContent" style="display: block;">
									<li>
										<a  target="_blank"><img src="${basepath}/image/l.jpg" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>									</li>
									<li>
										<a  target="_blank"><img src="${basepath}/image/m.jpg" style="display: block;"></a>									</li>
									
									<li>
										<a target="_blank"><img src="${basepath}/image/n.jpg" style="display: block;"></a>									</li>
									<li>
										<a target="_blank"><img src="${basepath}/image/o.jpg" style="display: block;"></a>									</li>
									<li>
										<a target="_blank"><img src="${basepath}/image/p.jpg" style="display: block;"></a>									</li>
									<li>
										<a target="_blank"><img src="${basepath}/image/m.jpg" style="display: block;"></a>									</li>
									<li>
										<a  target="_blank"><img src="${basepath}/image/15.jpg" style="display: block;"></a>
									<li>
										<a  target="_blank"><img src="${basepath}/image/l.jpg" data-original="http://storage.shopxx.net/demo-image/3.0/201301/b499fb5e-999f-431b-a375-172ee09e4a3e-thumbnail.jpg" style="display: block;" /></a>
									</li>
									<li>
										<a  target="_blank"><img src="${basepath}/image/l.jpg" data-original="http://storage.shopxx.net/demo-image/3.0/201301/b499fb5e-999f-431b-a375-172ee09e4a3e-thumbnail.jpg" style="display: block;" /></a>
									</li>
